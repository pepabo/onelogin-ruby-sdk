  ...
  class GenerateSamlAssertionRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OneLogin::GenerateSamlAssertionRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OneLogin::GenerateSamlAssertionRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'username_or_email')
        self.username_or_email = attributes[:'username_or_email']
      end
    ...
    def list_invalid_properties
      ...
      if @username_or_email.nil?
        invalid_properties.push('invalid value for "username_or_email", username_or_email cannot be nil.')
      end
    ...
    def valid?
      return false if @username_or_email.nil?
    ...
    def hash
      [username_or_email, password, app_id, subdomain, ip_address].hash
    end
